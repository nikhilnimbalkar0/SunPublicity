...
const CORPORATE_CATEGORY = "Corporate Ad Space";

export default function CorporateAdSpaceDashboard() {
    ...
    <>
      ...
      <main className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Corporate Ad Space</h1>
            ...
            >
              <div className="aspect-video bg-gray-100 overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://via.placeholder.com/800x450?text=Corporate+Ad+Space";
                  }}
                />
              </div>
