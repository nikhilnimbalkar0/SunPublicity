...
export default function LEDHording() {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                ...
                // Fetch from category sub-collection specifically for LED hording
                const categoryDocRef = doc(firestore, "categories", "LED hording");
                const colRef = collection(categoryDocRef, "hoardings");
                const snapshot = await getDocs(colRef);

                const list = snapshot.docs.map((doc) => normalizeHoardingData(doc.data(), doc.id, "LED hording"));
        ...
        <>
            ...
            <main className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
                    <h1 className="text-2xl md:text-3xl font-bold">LED Hording</h1>
                        ...
                        >
                            <div className="aspect-video bg-gray-100 overflow-hidden relative">
                                <img
                                    ...
                                    onError={(e) => {
                                        e.currentTarget.src = "https://placehold.co/800x450?text=LED+Hording";
                                    }}
                                />
                                <span
                            ...
                            <div className="p-5 space-y-3">
                                ...
                                <div className="pt-2 flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => navigate('/booking', { state: { item: { id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/led-hording/${b.id}` } } })}
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <button
                                                    onClick={() => toggle({ id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/led-hording/${b.id}` })}
