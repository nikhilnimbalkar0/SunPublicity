...
export default function HighwayDashboard() {
    ...
    <>
      ...
      <main className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Highway Display Dashboard</h1>
            ...
            >
              <div className="aspect-video bg-gray-100 overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://via.placeholder.com/800x450?text=Highway+Display";
                  }}
                />
              </div>
              <div className="p-4 space-y-3">
                ...
                <div className="pt-2 flex items-center justify-between gap-2">
                  ...
                  <button
                    onClick={() => navigate('/booking', { state: { item: { id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/highway/${b.id}` } } })}
                  ...
                  {(() => {
                    ...
                    return (
                      <button
                        onClick={() => toggle({ id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/highway/${b.id}` })}
