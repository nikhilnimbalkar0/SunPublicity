...
export default function AutoPromotion() {
  ...
  // Extract unique sizes from Firestore data for dynamic filter
  const availableSizes = useMemo(() => {
    const sizes = data.map(item => item.size).filter(Boolean);
    return ['All', ...new Set(sizes)].sort();
  }, [data]);
    ...
    <>
      ...
      <main className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Auto Promotion</h1>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading && (
            <div className="col-span-full text-center text-gray-500 py-10">Loading hoardings...</div>
          )}
          {!loading && error && (
            ...
            >
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="pt-2 flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => navigate('/booking', { state: { item: { id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/auto-promotion/${b.id}` } } })}
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          onClick={() => toggle({ id: b.id, location: b.location, size: b.size, price: b.price, image: b.image, href: `/auto-promotion/${b.id}` })}
          ...
          {!loading && !error && filtered.length === 0 && (
            <div className="col-span-full text-center text-gray-500 py-10">No hoardings found.</div>
          )}
        </section>
      </main>
    </>
